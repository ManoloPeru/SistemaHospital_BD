...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Text = L"Sistema Gestión Hospitalario - Médico - Actualizar información";
...
#pragma endregion
	...
	private: System::Void frmEditarMedico_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		this->txtNombre->Text = this->objMedico->getNombres();
		this->txtEdad->Text = Convert::ToString(this->objMedico->getFechaNacimiento());
		...
		this->txtTelefono->Text = this->objMedico->getTelefonos();
